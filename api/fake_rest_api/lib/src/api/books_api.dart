...
class BooksApi {
  ...
  Future<Response<BuiltList<Book>>> apiV1BooksGet({
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1BooksIdDelete({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/Books/{id}'.replaceAll('{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Book>> apiV1BooksIdGet({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1BooksIdPut({
    required int id,
    Book? book,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    try {
      const _type = FullType(Book);
      _bodyData = book == null
          ? null
          : _serializers.serialize(book, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1BooksPost({
    Book? book,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
